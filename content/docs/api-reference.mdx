...
# Track custom events
whispey.track_event(session_id, "user_completed_task", {"task": "booking"})
...
whispey.track_event(session_id, "call_started")
whispey.track_event(session_id, "user_identified", {"user_type": "premium"})
whispey.track_event(session_id, "call_ended", {"duration": 300})
