    ...
    if (currentFormik && assistantNames.length <= 1) {
      ...
      const assistant = {
        ...
        ...(formValues.advancedSettings?.session?.interruption_mode === 'adaptive' && {
          adaptive_min_duration: formValues.advancedSettings.interruption?.adaptiveMinDuration ?? 0.5,
          ...
          adaptive_false_interruption_timeout: formValues.advancedSettings.interruption?.adaptiveFalseInterruptionTimeout ?? 2.0,
          adaptive_backchannel_boundary_start: formValues.advancedSettings.interruption?.adaptiveBackchannelBoundaryStart ?? 1.0,
          adaptive_backchannel_boundary_end: formValues.advancedSettings.interruption?.adaptiveBackchannelBoundaryEnd ?? 3.5,
        }),
