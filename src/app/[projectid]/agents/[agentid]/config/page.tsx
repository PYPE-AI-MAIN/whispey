...
export default function ConfigPage() {
  ...
  // ── Pipecat redirect (from HEAD) ──────────────────────────────────────────
  // Fetch just enough to decide which sub-route to use. This runs before the
  // full config query so the redirect happens as early as possible.
  ...
  useEffect(() => {
    if (agentConfigData, isConfigLoading, agentNameWithId)
