  ...
  const renderEnhancedInsights = () => {
    ...
    return (
      <div className="space-y-6">
        {/* Cost Breakdown remains the same */}
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-center justify-between mb-4">
            <h4 className="text-lg font-semibold">Latency Analysis</h4>
            <Badge variant="outline" className={cn(
              "text-xs",
              isVapiAgent ? "bg-blue-50 text-blue-700 border-blue-300" : "bg-orange-50 text-orange-700 border-orange-300"
            )}>
          ...
          <div className="space-y-2">
              ...
              .map((stage) => {
                ...
                return (
                  <div key={stage.id} className={cn(
                    "flex justify-between items-center p-3 bg-white rounded",
                    isIncludedInPipeline ? "border border-blue-200" : "border border-gray-200 opacity-60"
                  )}>
                    <div className="flex items-center gap-3">
                    ...
                    <div className="text-right">
                      <span className={cn(
                        "font-mono text-sm",
                        isIncludedInPipeline ? "text-gray-900" : "text-gray-400"
                      )}>
            ...
            <div className="p-3 bg-white rounded border-2 border-blue-200 font-medium mt-4">
              ...
              <div className="text-xs text-gray-500 mt-2 font-mono">
                ...
                {!isVapiAgent && trace.stt_metrics?.duration && (
                  <span className="text-gray-400 ml-2">(STT excluded - parallel)</span>
                )}
              </div>
            </div>
          </div>
        ...
        {/* Session Information remains the same */}
