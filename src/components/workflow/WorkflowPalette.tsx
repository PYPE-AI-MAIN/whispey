                ...
                {items.map(([type, meta]) => (
                  <Tooltip key={type}>
                    <TooltipTrigger asChild>
                      ...
                      >
                        <div className="w-6 h-6 rounded flex items-center justify-center flex-shrink-0 bg-gray-100 dark:bg-gray-700">
                          <meta.icon className="w-3.5 h-3.5 text-gray-500 dark:text-gray-400" />
                        </div>
