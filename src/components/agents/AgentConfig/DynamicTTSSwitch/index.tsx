...
const DynamicTTSSwitch: React.FC<DynamicTTSSwitchProps> = ({
  ...
  const handleSave = () => {
    ...
    if (!/^[a-z][a-z0-9_]*$/.test(name)) { setToolNameError('Must be snake_case (lowercase letters, digits, underscores, no spaces)'); return }
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  maxLength={30}
                  onChange={(e) => { setCurrentConfig(prev => ({ ...prev, tool_name: e.target.value })); setToolNameError(null) }}
