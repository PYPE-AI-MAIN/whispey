...
const STT_PROVIDERS: STTProviders = {
  ...
  sarvam: {
    name: 'Sarvam AI',
    models: [
      { id: 'saarika:v2.5', name: 'Saarika v2.5', description: 'Same-language transcription (supports code-mixing)' },
      { id: 'saaras:v2.5', name: 'Saaras v2.5', description: '🌐 Speech→English translation (auto-detects all languages)' }
    ],
    languages: [
  ...
  const renderProviderSettings = () => {
    ...
    return (
      <div className="space-y-4 sm:space-y-6">
                ...
                if (value === 'custom') {
                  ...
                  if (activeProvider === 'openai') {
                    ...
                    setSarvamConfig(prev => ({ 
                      ...prev, 
                      model: value,
                      // Auto-set language to 'auto' for Saaras model
        ...
        {/* Language selector - Hide for Saaras (auto-detects) */}
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  {availableLanguages.filter(lang => lang.code !== 'auto').map((lang: any) => (
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-blue-700 dark:text-blue-300 mt-1">
                  Saaras automatically detects the input language and translates to English. No language configuration needed.
                </p>
              </div>
            </div>
          </div>
